...
print(green("La fiecare pas trebuie sa ghicesti o litera din cuvant,iar daca litera sa gaseste in cuvant se vor completa casutele goale cu toate aparitiile ei,dar daca nu se va completa omuletul la spanzuratoare.."))
print(magenta("Ai voie la maximul 5 greseli ca sa ghicesti cuvantul si ai posibilitatea(daca esti absolut sigur de raspuns) sa ghicesti cuvantul,dar daca nu este cuvantul care trebuie ai pierdut!.."))
print(red("De asemenea,iti poti selecta dificultatea:usor(cuvantul are 3 litere),mediu(cuvantul are 5 litere),dificil(cuvantul are 7 litere)"))
